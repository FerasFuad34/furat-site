...
html = html.replace('<link rel="stylesheet" href="/assets/css/style.css?v=37">', '<style>\n' + read('public/assets/css/style.css') + '\n</style>');
html = html.replace('<script src="/assets/js/art.js?v=37" defer></script>', '<script>\n' + read('public/assets/js/art.js') + '\n</script>');
html = html.replace('<script src="/assets/js/app.js?v=37" defer></script>', '<script>\n' + read('public/assets/js/app.js') + '\n</script>');
